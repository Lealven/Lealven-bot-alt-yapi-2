    ...
    if (user.presence.game.name === 'Spotify' && user.presence.game.type === 2) {
        try {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setFooter(`Mizzy Spotify Sistemi ${message.author.username} tarafından istendi.`, "https://cdn.discordapp.com/emojis/515260605347659777.png?v=1")
                .setDescription(`
...
`)
            ...
            return message.channel.send(` **${user.tag}** kullanıcısı şuanda **Spotify**'dan şarkı dinlemiyor.`);
        }

    } else {
        return message.channel.send(`**${user.tag}** kullanıcısı şuanda Discord'una **Spotify**'ı eklememiş`);
    }
};
