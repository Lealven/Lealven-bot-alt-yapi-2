...
exports.run = async(client, message, args) => {
 ...
 let rol = message.mentions.roles.first() || message.guild.roles.cache.get(args.join(' '))
  ...
  if (!message.guild.roles.cache.get(newRole)) return message.channel.send(" :x: Etiketlediğiniz rol bulunamadı, etiketlediğiniz rolün etiketlenebilirliğinin aktif olduğundan emin olunuz.")
