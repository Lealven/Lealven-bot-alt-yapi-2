...
if(!frenzy_sayı || !frenzy_kanal) return message.reply(`Sayaç Sistemini Ayarlamak İçin Lütfen Sayı ve Kanal Belirtiniz. **__Örnek__** : \`${prefix}sayaç #kanal 100\``)
...
exports.help = {
  name: 'sayaç',
  description: 'Sayaç Sistemi - Mizzy Code',
