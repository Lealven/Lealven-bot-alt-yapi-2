...
exports.run = function(bot, message, args) {
  ...
  message.delete(10000).catch(console.error);
    if (!message.member.voiceChannel) return message.reply("**Sana bağlanmam için ilk önce sesli bir kanala katılmalısın. :bangbang:**").then(m => m.delete(15000)).catch(console.error);
    else {
